export default {
  ...
  showImage:function(baseUrl,module,photo){
    let pics = photo.split(".")
    return baseUrl + 'system/showImage/'+ module + '/' + pics[0]
  },
  showImages:function(baseUrl,photo){
    let pics = photo.split(".")
    return baseUrl + 'system/showImageFile/'+pics[0]+ '/' + pics[1]
  },
  /**
   * 存储localStorage
   */
